...
## Enable Plugins
Add the following to the bottom of your `~/.zshrc` to enable the plugins installed via Homebrew:
...
# Finishing
Restart WezTerm to apply all changes. Enjoy your new terminal setup!
